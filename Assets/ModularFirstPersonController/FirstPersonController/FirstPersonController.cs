...
public class FirstPersonController : MonoBehaviour
{
    ...
    private string rightHand = "Service Provider (Desktop)/GhostHands/Generic Hand_Right/baseMeshHand_Right_GRP/Elbow/Wrist/index_meta/index_a";
    private string humanHead = "Joint";
    private Vector3 leftHand2human;
    private Vector3 rightHand2human;
...
*/
    ...
    void FixedUpdate()
    {
        ...
        if (playerCanMove)
        {
            ...
            leftHand2human = GameObject.Find(leftHand).GetComponent<Transform>().position - GameObject.Find(humanHead).GetComponent<Transform>().position;
            rightHand2human = GameObject.Find(rightHand).GetComponent<Transform>().position - GameObject.Find(humanHead).GetComponent<Transform>().position;
            Quaternion rotation = GameObject.Find(humanHead).GetComponent<Transform>().rotation;
            rotation.eulerAngles = new Vector3(0, 0, 0) - rotation.eulerAngles;
