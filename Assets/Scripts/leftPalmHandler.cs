...
public class leftPalmHandler : MonoBehaviour
{
    ...
    GameObject cue = GameObject.Find("Obj/Pool");
    GameObject whiteBall = GameObject.Find("Obj/Balls/Ball_00");
    GameObject leftHandIndex_a;
    GameObject rightHand_thumb = GameObject.Find("Service Provider (Desktop)/GhostHands/Generic Hand_Right/baseMeshHand_Right_GRP/Elbow/Wrist/middle_meta/middle_a");
